...
public class CategoryTabs extends RecyclerView {
    ...
    protected @Rotation.Enum
    int mLabelRotation = Rotation.NONE;
    ...
    protected class DefaultTabsAdapter extends CategoryTabs.LabelAdapter {
        ...
        public View onCreateLabel() {
            View view = View.inflate(getContext(), R.layout.default_toolbox_tab, null);
            return view;
        }
        ...
        public void onBindLabel(View labelView, BlocklyCategory category, int position) {
            ...
            TextView textView = labelView.findViewById(R.id.text);
            textView.setText(labelText);
            int[] backRes = new int[]{
                    R.drawable.shape_category,
                    R.drawable.shape_category_show,
                    R.drawable.shape_category_control
            };
            ...
            textView.setTextColor(colorRes[position%colorRes.length]);
            textView.setBackgroundResource(backRes[position % backRes.length]);
        }
