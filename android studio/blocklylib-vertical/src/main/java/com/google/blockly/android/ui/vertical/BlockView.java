...
public class BlockView extends AbstractBlockView<InputView> {
    ...
    @Nullable
    private Drawable mOutputConnectorHighlightPatch = null;
    @Nullable
    private Drawable mPreviousConnectorHighlightPatch = null;
    @Nullable
    private Drawable mNextConnectionHighlightPatch = null;
